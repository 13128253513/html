...
public class T_12306 {
	...
	private static String username = "a13128253513";							//昵称，用来验证是否登录成功
	
	private static String loginName = "13128253513";					//12306登录账号
	
	private static String password = "wp13128253513";				//12306登录密码
	...
	public static void main(String[] args) throws Exception{
		...
		get = new VHttpGet("https://kyfw.12306.cn/otn/leftTicket/query?"+sb.toString());
		res = client.execute(get);
		body = VHttpUtils.outHtml(res.getBody());
